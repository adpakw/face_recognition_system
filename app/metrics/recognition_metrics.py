...
class VideoIdentificationEvaluator:
    def __init__(self, known_identities: List[str], frame_finder: FrameFinder):
        ...
        self.per_person_stats = {id_: {'tp': 0, 'fp': 0, 'fn': 0, 'tn': 0} for id_ in known_identities}
        self.frame_results = []
    ...
    def _process_frame(self, frame_num: int, true_ids: List[str], pred_ids: List[Tuple[str, float]]):
