...
class FaceDetector:
    ...
    def process(
        ...
        if show_video:
            faces = [r["face_bbox"] for r in result["result_dicts"] if r["face_bbox"] is not None]
    ...
    def _process_face_bbox(self, face_bbox: Dict[str, Any], offset: tuple, frame_shape: tuple) -> Dict:
